...
int turn1 = 0, turn2 = 0, turn3 = 0, turn4 = 0; // turning for moving while one time only to turn
void loop() {
  int irr_1, irl_1,irr_2, irl_2;
  irr_1 = digitalRead(irr1);
  irl_1 = digitalRead(irl1);
  irr_2 = digitalRead(irr2);
  irl_2 = digitalRead(irl2);
  Serial.print(irr_1);
  Serial.print(", ");
